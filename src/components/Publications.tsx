      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            materials designed to support learners at every
              ...
              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="border-2 border-orange-200 rounded-lg p-6 hover:border-orange-500 transition-colors">
                    ...
                    <h4 className="text-gray-900 mb-2">NEET</h4>
                    <p className="text-gray-600 text-sm">
                  ...
                  <div className="border-2 border-amber-200 rounded-lg p-6 hover:border-amber-500 transition-colors">
                    ...
                    <p className="text-gray-600 text-sm">
                      State-focused preparation with solved
                  ...
                  <div className="border-2 border-orange-200 rounded-lg p-6 hover:border-orange-500 transition-colors">
                    ...
                    <p className="text-gray-600 text-sm">
                      Textbooks and study material strictly as
                      per Intermediate syllabus
                    </p>
                  </div>
                </div>
              </div>
